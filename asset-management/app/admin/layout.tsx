...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="bg-surface text-on-surface flex min-h-screen">
      <Sidebar />
      <main className="ml-sidebar-expanded flex-1 flex flex-col min-w-0">
        <TopNav />
        ...
        <footer className="flex justify-between items-center py-md px-lg bg-surface-container-lowest border-t border-outline-variant">
          <div className="flex items-center gap-md">
            <span className="text-label-md font-bold text-on-surface">AssetPro</span>
            <p className="text-body-sm text-on-surface-variant">© 2024 AssetPro Systems. All rights reserved.</p>
          </div>
