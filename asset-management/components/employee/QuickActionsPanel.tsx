const actions = [
  { icon: 'add_shopping_cart', label: 'Request Asset', desc: 'Need new equipment?' },
  { icon: 'visibility', label: 'View My Assets', desc: 'Check current inventory.' },
  { icon: 'assignment_return', label: 'Return Asset', desc: 'Starting an off-boarding.' },
];
    ...
    <div className="space-y-lg">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-sm">
          {actions.map((a) => (
            ...
            >
              <span className="material-symbols-outlined bg-surface-container-high group-hover:bg-primary-container p-sm rounded-lg">
                {a.icon}
              </span>
      ...
      <section className="bg-primary-container p-lg rounded-2xl text-on-primary-container relative overflow-hidden">
        <div className="relative z-10">
          ...
          <a
            href="mailto:support@assetpro.com"
            className="inline-block px-md py-sm bg-white text-primary rounded-lg font-bold text-label-md hover:bg-surface-container-lowest transition-colors"
          >
            Contact IT Support
          </a>
        </div>
