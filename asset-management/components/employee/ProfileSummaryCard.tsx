const stats = [
  { icon: 'laptop_mac', value: '4', label: 'Active Assets', valueClass: 'text-primary', iconClass: 'text-primary' },
  { icon: 'pending_actions', value: '1', label: 'Pending Requests', valueClass: 'text-tertiary', iconClass: 'text-tertiary' },
];
      ...
      <div className="bg-surface border border-outline-variant rounded-xl p-lg shadow-sm">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="relative group mb-md">
            ...
            <button className="absolute bottom-1 right-1 bg-primary text-white p-xs rounded-full shadow-lg hover:scale-110 transition-transform">
              <span className="material-symbols-outlined text-[18px]">photo_camera</span>
            </button>
          </div>

          <h2 className="text-headline-lg font-bold text-on-surface">Alex Rivera</h2>
          ...
          <div className="mt-md px-md py-xs bg-secondary-container/30 rounded-full">
            <span className="text-label-md text-on-secondary-container">Employee ID: #AP-99201</span>
          </div>

          {/* Details */}
          <div className="w-full mt-xl space-y-md text-left">
            {[
              { icon: 'mail', label: 'Email Address', value: 'a.rivera@assetpro.io' },
              { icon: 'corporate_fare', label: 'Department', value: 'Marketing & Communications' },
              { icon: 'calendar_today', label: 'Joined Date', value: 'March 12, 2021' },
            ].map((item) => (
